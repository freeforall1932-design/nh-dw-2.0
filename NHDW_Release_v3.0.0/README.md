...
Firefox (desktop and Android) is fully supported via the separate `NHDW_Firefox_v1.0.0` package (v1.4.1). It uses Firefox MV3 event pages (`background.scripts`), the website-embedded header UI drawer, and full parity with Chrome's multi-site download pipeline. See [`NHDW_Firefox_v1.0.0/README.md`](../NHDW_Firefox_v1.0.0/README.md).
