...
//
// Usage:
//   node scripts/e2e-browser.js --extension . [--browser /path/to/chromium] [--nss-libs /dir] [--headed|--headless]
//
// Environment:
...
const EXTENSION_DIR = argValue("--extension") || process.env.EXTENSION_DIR || path.join(__dirname, "..");
